...
public:
    ...
    // Essentially, to simulate defocus blur, we take camera ray origin samples in a disk centered around the actual camera center.
    // If you consider this disk and the pixel sample point to constitute a cone, the defocus angle is the angle at the tip of this cone.

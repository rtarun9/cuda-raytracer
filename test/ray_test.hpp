...
void ray_test()
{
    // at function test.
    {
        ...
        static_assert(at_5.r == 5.0f && at_5.g == 25.0f && at_5.b == 15.0f && "ray_test at (5) failed");

        constexpr const math::float3 at_minus_5 = ray.at(-5);
        static_assert(at_minus_5.r == -5.0f && at_minus_5.g == -25.0f && at_minus_5.b == -15.0f && "ray_test at (-5) failed");
    }
}